...
makedepends=('glproto>=1.4.9' 'xf86driproto>=2.0.4' 'mesa>=7.1' 'randrproto>=1.2.2' 'renderproto>=0.9.3' 'scrnsaverproto>=1.1.0' 'resourceproto>=1.0.2' 'fontsproto>=2.0.2' 'videoproto>=2.2.2' 'compositeproto>=0.4' 'trapproto>=3.4.3' 'resourceproto>=1.0.2' 'xineramaproto>=1.1.2' 'evieext>=1.0.2' 'libxkbfile>=1.0.5' 'libxmu>=1.0.4' 'libxpm>=3.5.7' 'libxxf86dga>=1.0.2' 'inputproto>=1.4.4' 'xcmiscproto>=1.1.2')
options=('!libtool')
provides=('x-server')
groups=('xorg')
...
md5sums=('9a817e5f7374d45b4dbe64b21bc0fb61'
